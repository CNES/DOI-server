...
public class ValidationMetadataException extends Exception {
    ...
    /**
     * Constructs a new ValidationMetadataException with null as its detail
     * message. The cause is not initialized, and may subsequently be
     * initialized by a call to ValidationMetadataException.initCause.
     */
    ...
    /**
     * Constructs a ValidationMetadataException with the specified detail
     * message. The cause is not initialized, and may subsequently be
     * initialized by a call to DoiRuntimeException.initCause.
     *
    ...
    /**
     * Constructs a ValidationMetadataException with the specified cause and a
     * detail message of (cause==null ? null : cause.toString()) (which
     * typically contains the class and detail message of cause). This
     * constructor is useful for ValidationMetadataException that are little
     * more than wrappers for other throwables.
     *
     * @param cause the cause (which is saved for later retrieval by the
     * ValidationMetadataException.getCause() method). (A null value is
