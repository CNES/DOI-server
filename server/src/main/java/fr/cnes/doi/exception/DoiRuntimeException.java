...
public class DoiRuntimeException extends RuntimeException {
     ...
     * detail message associated with cause is not automatically incorporated in this runtime
     * exception's detail message.
     *
     * @param message the detail message (which is saved for later retrieval by the
     * DoiRuntimeException.getMessage() method).
     * @param cause the cause (which is saved for later retrieval by the
     * DoiRuntimeException.getCause() method). (A null value is permitted, and indicates that the
