...
public class FormatCitationResource extends BaseCitationResource { 
     ...
     * @throws ResourceException - if a problem happens when requesting 
     * Cross Cite or if {@link #DOI_PARAMETER} and {@link #LANG_PARAMETER} 
     ...
     * @throws ResourceException - if {@link #DOI_PARAMETER} and {@link #LANG_PARAMETER}
     * and {@link #STYLE_PARAMETER} are not set
     */
