 ...
 */
public class DefaultTokenImplTEST extends AbstractTokenDBPluginHelper {
     ...
     * Logger.
     */
    private static final Logger LOG = LogManager.getLogger(DefaultTokenImplTEST.class.getName());
