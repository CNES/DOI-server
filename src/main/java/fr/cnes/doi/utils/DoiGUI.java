...
public class DoiGUI extends javax.swing.JDialog {
    ...
    private static final String TEMPLATE_XML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
	    ...
	    + "    <creators>\n" + "        <creator>\n" + "            <creatorName>" + CREATOR_TPL
	    + "</creatorName>\n" + "        </creator>\n" + "    </creators>\n" + "    <titles>\n"
	    + "        <title>" + TITLE_TPL + "</title>\n" + "    </titles>\n" + "    <publisher>"
	    + PUBLISHER_TPL + "</publisher>\n" + "    <publicationYear>" + YEAR_TPL
	    + "</publicationYear>\n" + "    <resourceType resourceTypeGeneral=\"Other\">"
	    + RESOURCE_TYPE_TPL + "</resourceType>\n" + "</resource>";
	...
	jLabel9.setIcon(new javax.swing.ImageIcon(
		new javax.swing.ImageIcon(getClass().getResource("/website/images/Cnes-logo.png"))
	...
	jPanel1Layout.setHorizontalGroup(jPanel1Layout
		...
		.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
			.addComponent(jLabel9, javax.swing.GroupLayout.PREFERRED_SIZE, 213,
				javax.swing.GroupLayout.PREFERRED_SIZE)
			.addGap(61, 61, 61).addComponent(jLabel1)
			.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
		.addGroup(jPanel1Layout.createSequentialGroup()
			.addComponent(jSeparator1, javax.swing.GroupLayout.PREFERRED_SIZE, 743,
				javax.swing.GroupLayout.PREFERRED_SIZE)
	...
	resourceTypeField.setToolTipText(
	...
	jPanel2Layout.setHorizontalGroup(jPanel2Layout
		.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap(29, Short.MAX_VALUE)
	...
	jPanel2Layout.setVerticalGroup(jPanel2Layout
		...
		.addGroup(jPanel2Layout.createSequentialGroup().addGap(21, 21, 21)
			.addGroup(jPanel2Layout
				...
				.addComponent(jLabel7).addComponent(inistPrefixLabel)
				.addComponent(jLabel8).addComponent(projectNameLabel))
			.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
				javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
			.addGroup(jPanel2Layout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
				.addComponent(jLabel2).addComponent(landingPageField,
					javax.swing.GroupLayout.PREFERRED_SIZE,
					javax.swing.GroupLayout.DEFAULT_SIZE,
					javax.swing.GroupLayout.PREFERRED_SIZE))
			.addGap(18, 18, 18)
			.addGroup(jPanel2Layout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
				.addComponent(jLabel3).addComponent(creatorField,
					javax.swing.GroupLayout.PREFERRED_SIZE,
					javax.swing.GroupLayout.DEFAULT_SIZE,
					javax.swing.GroupLayout.PREFERRED_SIZE))
			.addGap(18, 18, 18)
			.addGroup(jPanel2Layout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
				.addComponent(jLabel4).addComponent(titleField,
					javax.swing.GroupLayout.PREFERRED_SIZE,
					javax.swing.GroupLayout.DEFAULT_SIZE,
					javax.swing.GroupLayout.PREFERRED_SIZE))
			.addGap(18, 18, 18)
			.addGroup(jPanel2Layout
				...
				.addComponent(publisherField,
					...
					javax.swing.GroupLayout.DEFAULT_SIZE,
					javax.swing.GroupLayout.PREFERRED_SIZE)
				.addComponent(jLabel10).addComponent(yearField,
					javax.swing.GroupLayout.PREFERRED_SIZE,
					javax.swing.GroupLayout.DEFAULT_SIZE,
					javax.swing.GroupLayout.PREFERRED_SIZE))
			.addGap(18, 18, 18)
			.addGroup(jPanel2Layout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
				.addComponent(jLabel6).addComponent(resourceTypeField,
					javax.swing.GroupLayout.PREFERRED_SIZE,
					javax.swing.GroupLayout.DEFAULT_SIZE,
					javax.swing.GroupLayout.PREFERRED_SIZE))
			.addGroup(jPanel2Layout
	...
	if (errorMsg.length() != 0) {
	    ...
	    try {
		final String createdDOI = UniqueDoi.getInstance().createDOI(
			this.inistPrefixLabel.getText(), this.projectNameLabel.getText(),
    ...
    private String createXMLFile(final String landingPage, final String creator,
	    final String publisher, final String doi, final String title, final String resourceType,
	...
	try {
	    ...
	    java.util.logging.Logger.getLogger(DoiGUI.class.getName())
