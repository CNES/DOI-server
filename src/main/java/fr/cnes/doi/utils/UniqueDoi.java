...
public class UniqueDoi {
    ...
    public String createDOI(final String inist_prefix,
        ...
        if (length > 9) {
            ...
            LOGGER.log(Level.FINE, "The landing page {0} has a doi : {1}",
                    new Object[]{landingPage, doi});
        }
    ...
    /**
     * Check if the generated DOI is unique (does not already exists) or not. If not add it
     * associated with the landing page
     *
