...
public enum ContributorType {
     ...
     * May also be "Point of Contact" in organisation that controls access
     * to the resource, if that organisation is different from Publisher, 
     ...
     * May also use when crediting survey conductors, interviewers, event or 
     * condition observers, person responsible for monitoring key instrument data.
     */
     ...
     * While the "DataManager" is concerned with digital maintenance, the 
     * DataCurator’s role encompasses quality assurance focused on content and
     * metadata. This includes checking whether the submitted dataset is complete,
     * with all files and components as described by submitter, whether the 
     * metadata is standardized to appropriate systems and schema, whether
     ...
     * The work done by this person or organisation ensures that the resource is
     * periodically "refreshed" in terms of software/hardware support, is kept 
     * available or is protected from unauthorized access, is stored in accordance
     * with industry standards, and is handled in accordance with the records 
     ...
     * Works stored in more than one archive/repository may credit each as a 
     * distributor.
     */
     ...
     * the resource.
     * Note: if the Editor is to be credited in place of multiple creators, the
     * Editor's name may be supplied as Creator, with "(Ed.)" appended to the name.     
     */
    @XmlEnumValue("Editor")
    EDITOR("Editor"),
    /**
     ...
     * May also be used for an organisation that stores the data offline. Often 
     * a data centre (if that data centre is not the "publisher" of the resource.)     
     */
     ...
     * Could be a photographer, artist, or writer whose contribution helped to 
     * publicize the resource (as opposed to creating it), a reviewer of the 
     * resource, someone providing administrative services to the author (such 
     * as depositing updates into an online repository, analysing usage, etc.), 
     * or one of many other roles.
     */
    @XmlEnumValue("Other")
    OTHER("Other"),
    /**
     ...
     * of a media product.
     * In the data industry, this may be a company "producing" DVDs that package 
     * data for future dissemination by a distributor
     */
     ...
     * The Project Leader is not "removed" from the work that resulted in the 
     * resource; he or she remains intimately involved throughout the life of the
     ...
     * The manager of a project normally has more administrative responsibility 
     * than actual work involvement.
     */
    @XmlEnumValue("ProjectManager")
    PROJECT_MANAGER("ProjectManager"),
    /**
     * Person on the membership list of a designated project/project team.
     * This vocabulary may or may not indicate the quality, quantity, or 
     * substance of the person's involvement.
     */
     ...
     * (IDF). One of DataCite's tasks is to assign DOI prefixes to the allocating 
     * agents who then assign the full, specific character string to data clients,
     ...
     * The IDF serves as the Registration Authority for the International Standards
     ...
     * This person could be an author's intellectual mentor, a person providing 
     * intellectual leadership in the discipline or subject domain, etc
     */
     ...
     * May operate at a narrower level of scope; may or may not hold less 
     ...
     * author.
     * Should be a person, not an institution. Note that a person involved in 
     * the gathering of data would fall under the contributorType "DataCollector."
    ...
    SPONSOR("Sponsor"),
    /**
     * Designated administrator over one or more groups/teams working to 
     * produce a resource or over one or more steps of a development process.
     */
