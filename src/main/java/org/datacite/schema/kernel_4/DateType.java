...
public enum DateType {
     ...
     * To indicate the start of an embargo period, use Submitted or Accepted, as
     * appropriate.
     */
    ...
    COLLECTED("Collected"),
    /**
     * The specific, documented date at which the resource receives a copyrighted
     ...
     * different from Accepted if the publisher then applies a selection process.
     * Recommended for discovery. To indicate the start of an embargo period, 
     * use Submitted or Accepted, as appropriate.
     */
