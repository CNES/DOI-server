...
public class ObjectFactory {
    ...
    private static final QName _ResourceDescriptionsDescriptionBr_QNAME = new QName(
    ...
    public JAXBElement<String> createResourceDescriptionsDescriptionBr(String value) {
        return new JAXBElement<String>(_ResourceDescriptionsDescriptionBr_QNAME, String.class,
