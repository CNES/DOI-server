$(document).ready(function () {
	...
	$("body").on("click", "button#more", function (event) {
		event.preventDefault();
		var div = $(this).parent();
		$(div).find("button#more").addClass("hidden");
		$(div).find("div#subgroup,button#less").removeClass("hidden");
	});
	$("body").on("click", "button#less", function (event) {
		event.preventDefault();
		var div = $(this).parent();
		$(div).find("div#subgroup,button#less").addClass("hidden");
		$(div).find("button#more").removeClass("hidden");
