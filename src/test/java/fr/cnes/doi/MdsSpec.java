...
public class MdsSpec extends AbstractSpec {
    ...
    public enum Spec {
        ...
        DELETE_METADATA_500("Fail to delete DOI metadata due to an internal server error", HttpMethods.DELETE, "/" + ClientMDS.METADATA_RESOURCE, "10.5072/EDU/TESTID", 500, "server internal error, try later and if problem persists please contact us"),          GET_MEDIA_200("Get media", HttpMethods.GET, "/" + ClientMDS.MEDIA_RESOURCE, "10.5072/EDU/TESTID", 200, "application/fits=http://cnes.fr/test-data"), 
